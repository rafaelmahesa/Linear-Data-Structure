...
public class LinkedList {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        int hapus = list.removeLast();
        System.out.println("Nilai " + hapus + " di akhir dihapus");
        System.out.println(list.toString());
        System.out.println();
        list.addLast(15);
        System.out.println("Menambahkan nilai 15 di akhir");
        System.out.println(list.toString());
        System.out.println();
        System.out.println("Total jumlah data: " + list.size);
    }
}
